...
public class MessOrFacilitiesListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.m_activity_mess_or_facilities_list);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url + type,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        content_adapter = new AdapterClass(MessOrFacilitiesListActivity.this, R.layout.m_activity_mess_or_facilities_list);
